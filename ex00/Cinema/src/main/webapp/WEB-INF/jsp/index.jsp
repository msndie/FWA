    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mt-4 mx-auto">
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <a class="btn btn-primary btn-lg px-4 gap-3" href="signIn.html" role="button">Sign&nbsp;In</a>
                <a class="btn btn-primary btn-lg px-4 gap-3" href="signUp.html" role="button">Sign&nbsp;Up</a>
